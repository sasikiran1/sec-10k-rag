...
| 3 | + cross-encoder reranker (ms-marco-MiniLM-L-6-v2, top-25 → 6) | 63.6% | 57.9% | 0.230 | +9 acc, +16 recall. But comparison acc fell 67→33: the CE prefers question-phrase matches over the multi-year table. 5 of 8 remaining misses are NVIDIA (Item 15 chunking). |
